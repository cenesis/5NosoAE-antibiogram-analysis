...
#Acinetobacter_baumannii 9840
dataset[1,] = (dataset[1,]/9840)

#Enterococcus_faecium 15168
dataset[2,] = (dataset[2,]/15168)

#Klebsiella_pneumoniae 21804
dataset[3,] = (dataset[3,]/21804)

#Pseudomonas_aeruginosa 6726
dataset[4,] = (dataset[4,]/6726)

#Staphylococcus_aureus 35678
dataset[5,] = (dataset[5,]/35678)
...
pdf(file="results/figures/heatmap_frequency_c100.pdf", width=5, height=14)  #直的顯示
...
#直的顯示
pheatmap(tM2, name = "Antibiotic \nfrequency\n", annotation_row = annotation_col, annotation_colors = ann_colors, annotation_legend = FALSE, clustering_method = "complete", cluster_rows = FALSE, cluster_cols = FALSE, cellwidth = 18, cellheight = 10.5, fontsize_col = 10, fontsize_row = 10, angle_col = "90", color = colorRampPalette(c("white", "#1F45FC", "navy"))(20), labels_col = as.expression(newnames))
